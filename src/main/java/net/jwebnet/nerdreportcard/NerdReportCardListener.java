...
public final class NerdReportCardListener implements Listener {
    
    
    public NerdReportCardListener(NerdReportCard plugin) {
    ...
    public void normalJoin(PlayerJoinEvent event) {
        // Some code here
        event.getPlayer().sendMessage("Here is your report card.");
    }
